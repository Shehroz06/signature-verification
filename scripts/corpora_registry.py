...
This downstream project (signature verification) only registers its own
corpus. Adding another one means writing a loader function here and a
matching `configs/corpus/<name>.yaml` file -- not a new training script.
